package com.together.common.utils;

import com.together.board.service.ObjectStorageService;
...
public class TempImageCleaner {
    ...
    private final String tempDirectoryPath = "temp/";
    ...
    public void cleanTempImages() {
        ...
        // 2일 이전에 생성된 폴더 삭제
        objectStorageService.deleteDirectory(tempDirectoryPath+cutoffDate);
    }
}
