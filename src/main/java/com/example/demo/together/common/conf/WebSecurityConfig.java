        ...
        http.authorizeHttpRequests((authorizeRequests) ->
                        authorizeRequests
                            //.anyRequest().permitAll()
                                ...
                                .requestMatchers("/mentor/getMentorList","/comment/getCommentList","/mentor/writeImage","/volunteer/getWriteList","/volunteer/writeImage","/volunteer/getUpdateBoard").permitAll()//글목록확인 | 이미지 임시 업로드. 권한 확인하려면 csrf 토큰 처리 필요.
                                .requestMatchers("/member/idCheck","/search/query","mentor/getOneMentor").permitAll()
                                ...
                                .requestMatchers("/comment/writeComment", "/comment/getOneComment", "/comment/updateComment", "deleteComment").hasRole("USER")
