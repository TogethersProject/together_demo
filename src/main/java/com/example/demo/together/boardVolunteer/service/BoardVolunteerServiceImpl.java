...
public class BoardVolunteerServiceImpl implements BoardVolunteerService {
    ...
    private String tempDir = "volunteer/temp/";//임시 폴더 이름
    private String testDir = "volunteer/board/";//영구 폴더 이름


    @Override
    public void writeBoard(BoardVolunteerDTO boardDTO) {
        System.out.println("글작성 서비스 진입");
        String tempDir = "volunteer/temp";
        String testDir = "volunteer/board";
    ...
    //글 목록 정보 전달
    @Override
    public Page<BoardVolunteerDTO> getWriteList(Pageable pageable) {
        Page<BoardVolunteerDTO> list = boardDAO.findAll(pageable);
        return list;
    }
    ...
    @Override
    public void updateBoard(List<String> imageNamesBefore, BoardVolunteerDTO boardDTO) {
